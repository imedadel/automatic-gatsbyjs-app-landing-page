      ...
      <div className="headerBackground">
        <div className="container">
          <header>
            ...
            <div className="iphonePreview" style={{backgroundImage: `url(${data.iphonePreview.childImageSharp.fluid.src})`}}>
            ...
            <div className="appInfo">
                ...
                <div className="downloadButtonsContainer">
                    ...
                    <a className="appStoreLink" href="/"><Img fixed={data.appStore.childImageSharp.fixed} className="appStore" /></a>
                </div>
            </div>
